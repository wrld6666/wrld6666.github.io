	...
	window.onload = function () {
		...
		const sections = [
			...
			{section: "Invites", renderSection: _ => [
				createInvite({invite: "hzfPTzP5F4", name: "wlrd's DB", details: "Support Server for all my Stuff", icon: "https://cdn.discordapp.com/icons/1058497149039550544/6ea5cfca6bcbdb66f595b7603ebbf3ad.webp?size=96"}),
				createElement(`<div class="divider"></div>`),
				createInvite({invite: "kkpvkJBVjt", name: "HazardUnlocked", details: "MW2/WZ2 Cheat made by me", icon: "https://cdn.discordapp.com/icons/927315035028611113/329b315ca921ac54f742ad624ee7928f.webp?size=96"}),
				createInvite({invite: "scripting", name: "Script-Ware", details: "A Roblox Scripting server", icon: "https://cdn.discordapp.com/icons/878796318137524245/a_9261369dd7142728ba98a7414201936c.webp?size=96"})
			]}
		];
		let items = [];
